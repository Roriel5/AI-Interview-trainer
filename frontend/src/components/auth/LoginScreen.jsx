    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-950 px-4">
      <div className="max-w-md w-full p-8 rounded-2xl glass border border-slate-800/80 shadow-2xl relative overflow-hidden">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl font-bold gradient-text">Welcome to AIview</h2>
          <p className="mt-1.5 text-xs text-slate-400">Perfect your skills with AI mock interviews</p>
        </div>
        ...
        <div className="text-center mt-6">
          <p className="text-xs text-slate-400">
            ...
            <button onClick={onNavigateToSignup} className="text-indigo-400 hover:text-indigo-300 font-medium hover:underline transition">
              Create one
            </button>
          </p>
        </div>
